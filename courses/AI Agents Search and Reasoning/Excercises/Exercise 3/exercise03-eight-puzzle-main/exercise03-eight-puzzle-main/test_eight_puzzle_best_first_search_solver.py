...
class TestEightPuzzleBestFirstSearchSolver(unittest.TestCase):
    ...
    # def test_7_2_4_5_n_6_8_3_1(self):
    #     """
    #     The solution for (7, 2, 4, 5, None, 6, 8, 3, 1) is found correctly.
    #     """
    ...
    #     solver = EightPuzzleBestFirstSearchSolver()
    #     expected = [
    #         EightPuzzleAgent.move_up,
    #         EightPuzzleAgent.move_left,
    #         EightPuzzleAgent.move_down,
    #         EightPuzzleAgent.move_right,
    #         EightPuzzleAgent.move_up,
    #         EightPuzzleAgent.move_left,
    #         EightPuzzleAgent.move_down,
    #         EightPuzzleAgent.move_right,
    ...
    # def test_8_none_6_5_4_7_2_3_1(self):
    #     """
    #     The solution for (8, None, 6, 5, 4, 7, 2, 3, 1) is found correctly.
    #     """
